...
function getAngularJsonValue(tree) {
    const angularJsonAst = (0, json_1.parseJsonAtPath)(tree, './angular.json');
...
function getPackageJsonDependency(tree, name) {
    const packageJson = (0, json_1.parseJsonAtPath)(tree, types_1.pkgJson.Path);
    let dep = null;
    [
...
function removePackageJsonDependency(tree, dependency) {
    const packageJsonAst = (0, json_1.parseJsonAtPath)(tree, types_1.pkgJson.Path);
...
function addPackageJsonDependency(tree, dependency) {
    ...
    if (!depsNode) {
        ...
        (0, json_1.appendPropertyInAstObject)(recorder, packageJsonAst, dependency.type, {
        ...
        if (!depNode) {
            ...
            (0, json_1.insertPropertyInAstObjectInOrder)(recorder, depsNode, dependency.name, dependency.version, 4);
        }
